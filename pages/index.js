          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-7xl lg:mx-0">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-300">
                ...
                leaving our lot! We never compromise on quality, even if it
                means taking extra time, and we always offer availability that
                aligns with our clients&apos; schedules. Honesty is our
                foundation for providing exceptional customer service, Rest
                assured, this is our commitment to you.
              </p>
            </div>
